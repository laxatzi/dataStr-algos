//. Q: Remove Duplicate Elements from an Array
{
 ...
 function removeDuplicates(arr){
     return arr.sort().reduce(function(acc ,curr){
       //if condition below, could be followed by "return acc.push(curr)" but according to MDN, push() returns the new length property of the array upon it was called and not the array itself, thus in the second iteration acc is a number (length) so push method is impossible to apply. The solution to this is to push without return. The acc will be returned anyway in the next line(12).
