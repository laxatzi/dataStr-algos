  ...
  // Flatten a nested array. You must account for varying levels of nesting.
{
	function steamrollArray(arr) {
		...
		return 'flatten deep nested arrays';
	}
...
//Arguments Optional
   ...
   // It has to check if any of the numbers are actual numbers, otherwise return undefined 
   // and stop the program right there.
   // It has to check if it has one or two arguments passed. More are ignored.
   // If it has only one argument then it has to return a function that uses that number and expects another one, 
   // to then add it.
